...
interface MovieCardProps {
  ...
  userStatus?: "want_to_watch" | "watched" | null;
  userRate?: number;
  index?: number;
}
...
export function MovieCard({
  ...
  const imdbRating = typeof title.rating === "number" ? title.rating : 0;
      ...
      >
        <Link to={`/title/${mediaType}/${title.id}`}>
          <div
            ...
            style={{
              aspectRatio: isLarge ? "16/10" : "2/3",
            }}
          >
            <img
              src={title.poster_path ?? undefined}
              alt={title.title}
